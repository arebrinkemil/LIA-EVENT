...
export const CompanyDetails = ({ company }) => (
  <div className="px-4">
    <div className="flex items-center">
      <label className="text-xl font-bold nowrap leading-3">Roll:</label>
      <div className=" text-xl py-2 w-full leading-3">{company.role}</div>
    </div>
    <div className=" flex items-center">
      <label className="text-xl font-bold nowrap leading-3">Plats:</label>
      <div className=" text-xl py-2 w-full leading-3">{company.location}</div>
    </div>
    <div className=" flex items-center">
      <label className="text-xl font-bold nowrap mr-1 leading-3">
        Lia-platser:
      </label>
...
export const CompanyContact = ({ company }) => (
  <div>
    ...
    <div className="px-4 my-4">
      <label className="text-xl mr-4 text-gray-500 font-bold">URL</label>
